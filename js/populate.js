$(document).ready(function () {
    ...
    var basic_itinerary_tanzania = [
        ...
        {
            day: 3,
            description: "ERENGETI NATIONAL PARK"+
        ...
        {
            day: 5,
            description: "NGORONGORO CRATER - LAKE NATRON"+
    ...
    var premium_itinerary_tanzania = [
        {
            day: 1,
            description: "AKE NAKURU NATIONAL PARK"+
        ...
        {
            day: 4,
            description: "FROM MAASAI MARA TO SERENGETI NATIONAL PARK"+
        ...
        },
        {
            day: 6,
            description: "SERENGETI NATIONAL PARK"+
            "Many smaller animals like rock hyrax, bat eared foxes, mongoose, honey badger, jackals, monkeys, baboons and African hares also inhabit the area along with nearly 500 species of birds.On the way into the Serengeti, option to stop at the famous Olduvai Gorge, where Dr. Louis and Mary Leakey made their discovery of the first man that walked the earth. After attending a short lecture describing the archeological digs and geology of the gorge, you'll have time to visit the small museum. Afternoon game drive en-route to campsite.Dinner and overnight at public campsite or private tented camp or lodge.",
            image: "../resources/tours_specific/tours.jpg"
        },
        {
            day: 7,
            description: "SERENGETI NP TO NGORONGORO CONSERVATION AREA"+
        ...
        {
            day: 11,
            description: "AMBOSELI NATIONAL PARK TO NAIROBI"+
    ...
    var basic_itinerary_quenia = [
        {
            day: 1,
            description: "HELL'S GATE / LAKE NAIVASHA NATIONAL PARK"+
